...
public class ObstacleBehaviour : MonoBehaviour
{
    ...
    {
        RaycastHit2D hit = Physics2D.Raycast(rb.position, -transform.up, 0.51f);
        //Debug.Log(hit);
        Debug.DrawRay(rb.position, -transform.up*(transform.lossyScale.x*0.51f),Color.blue);
        return Physics2D.Raycast(rb.position, -transform.up,(transform.lossyScale.x * 0.51f));
    }
